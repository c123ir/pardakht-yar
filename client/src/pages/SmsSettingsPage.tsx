...
const StatsIconWrapper = styled(Box)(({ theme }: { theme: Theme }) => ({
  borderRadius: '50%',
...
const SmsSettingsPage: React.FC = () => {
  const { toast, showNotification: showToast, hideToast } = useNotification();
                    ...
                    <Grid item xs={12}>
                      <Box 
                        sx={{ 
                          ...
                          borderColor: 'divider',
                          borderRadius: 1,
                          bgcolor: (theme: Theme) => alpha(theme.palette.info.main, 0.03),
                        }}
                      >
                        <Typography variant="body2" color="text.secondary">
                        ...
                        <Box
                          sx={(theme: Theme) => ({
                            ...
                            background: `conic-gradient(
                              ${theme.palette.success.main} 0% ${(stats.deliveredCount / (stats.deliveredCount + stats.failedCount)) * 100}%,
                              ${theme.palette.error.main} ${(stats.deliveredCount / (stats.deliveredCount + stats.failedCount)) * 100}% 100%
                            )`,
                            opacity: 0.7,
                          })}
                        />
